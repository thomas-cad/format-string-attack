...
L'instruction explicite \texttt{pop rdi} n'est pas présente. Cependant, l'instruction \texttt{pop r15} (\code{41 5f}) située à la fin de la fonction d'initialisation permet de la simuler en sautant le premier octet.
